...
if __name__ == '__main__':
    ...
    # Model Parameters
    parser.add_argument('--input_features', type=int, default=2, metavar='N', help='# of input features')
    parser.add_argument('--hidden_dim', type=int, default=10, metavar='N', help='dimension of hidden layer(s)')
    parser.add_argument('--output_dim', type=int, default=1, metavar='N', help='dimension of output layer')
